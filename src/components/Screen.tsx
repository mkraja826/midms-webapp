...
import {
  WorkflowBottomNav,
  type WorkflowBottomNavItem,
} from "@/components/WorkflowBottomNav";
...
function getActiveBottomNavKey(role: BottomNavRole, pathname: string) {
  ...
  if (
    pathname.startsWith("/reports/payments") ||
    pathname.startsWith("/payment") ||
    pathname.startsWith("/patient/payment")
  ) {
    return "money";
  }
  if (pathname.startsWith("/treatments") || pathname.startsWith("/reports/treatments")) {
    return "treatments";
  }
  if (pathname.startsWith("/patient")) return "patients";
  return "more";
  ...
  return (
    ...
    >
      ...
      >
        ...
        {resolvedBottomBar ? (
          <View style={{ backgroundColor: colors.background }}>{resolvedBottomBar}</View>
        ) : null}
      </KeyboardAvoidingView>
    </SafeAreaView>
  );
