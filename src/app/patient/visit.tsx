...
export default function AddVisitScreen() {
  ...
  async function saveVisit() {
    ...
    if (followupDateTime && followupDateTime.getTime() <= Date.now()) {
      Alert.alert("Invalid appointment", "Follow-up must be future date/time.");
      return;
    }
  ...
  return (
    <Screen refreshing={loadingPatients} onRefresh={loadPatients}>
          ...
          {COMPLAINTS.map((item) => {
            ...
            return (
              ...
              >
                ...
                <View style={{ gap: 4 }}>
                  <Text style={{ color: selected ? colors.white : colors.text, fontWeight: "900", fontSize: 15 }}>
                    {item.label}
                  </Text>
                  <Text numberOfLines={2} style={{ color: selected ? "rgba(255,255,255,0.78)" : colors.muted, fontSize: 11, lineHeight: 15 }}>
                    {item.hint}
                  </Text>
                </View>
              </Pressable>
      ...
      <SectionCard title="Follow-up Appointment" subtitle="Optional. Scroll month/day and time. Year saves automatically.">
        <Pressable
              ...
              {dateOptions.map((option) => {
                ...
                return (
                  ...
                  >
                    ...
                    <Text style={{ color: selected ? "rgba(255,255,255,0.75)" : colors.muted, fontSize: 11 }}>{option.weekday}</Text>
                  </Pressable>
                );
              })}
            </ScrollView>
      ...
      <AppButton title="Save Visit & Complete Queue" icon="save-outline" onPress={saveVisit} loading={saving} />
